...
const Modal5 =() => (
<div className="portfolio-modal modal fade" id="portfolioModal5" tab-index="-1" role="dialog" aria-hidden="true">
            ...
            <div className="container">
                <div className="row">
                  ...
                  <h2 className="text-uppercase">Trust Attorneys</h2>
                            ...
                            <img className="img-fluid d-block mx-auto" src="assets/img/law.jpg" alt=""></img>
                                <p>Los Angeles Area
                                    ...
                                    Phone:866-791-5383 (Toll Free)<br/>
                                    818-676-9572<br/>
                                    818-878-8301<br/>
                                    Fax:818-716-9275<br/>
