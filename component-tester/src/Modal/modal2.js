        ...
        <div class="modal-content">
            ...
            <div class="container">
                <div class="row">
                  ...
                  <h2 class="text-uppercase">Assisted Living</h2>
                            <p class="item-intro text-muted">Housing for the elderly or disabled that provides nursing care including medication, housekeeping, and prepared meals as needed.</p>
                            {/* <img class="img-fluid d-block mx-auto" src="assets/img/assist.jpg" alt=""> */}
